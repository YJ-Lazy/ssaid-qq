...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams forceLp = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void oneClickModify() {
        ...
        prefs.edit().putString(App.KEY_ID, newId).apply();
        refreshCurrentId();
    ...
    private void refreshCurrentId() {
        ...
        if (id == null || id.isEmpty()) {
            currentIdView.setText("（尚未设置，点击下方按钮生成）");
        } else {
            currentIdView.setText(id);
        }
    }
